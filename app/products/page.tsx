...
const ProductPage = () => {
  return (
    <section className="pt-20 px-4 md:px-10 bg-smoke-white">
      ...
      <h1 className="text-center text-2xl md:text-4xl font-semibold mt-10"> All Products</h1>
      ...
      {/* <motion.section
        ...
        className="container mx-auto grid grid-cols-2 xs:grid-cols-3 sm:grid-cols-4 gap-3 sm:gap-4 md:gap-6 px-3 sm:px-6 lg:px-8"
      >
