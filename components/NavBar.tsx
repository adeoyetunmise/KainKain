...
const NavBar = () => {
  ...
  return (
    ...
    >
      ...
      >
        <button className="absolute top-4 left-4 text-black cursor-pointer" onClick={() => setMenuOpen(false)}>
          <X className="h-6 w-6" />
        </button>
        ...
        <ul className="menu menu-vertical w-full">
          <li>
            <Link href="/" className="text-sm sm:text-lg font-semibold" onClick={() => setMenuOpen(false)}>
              Home
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link href="/products" className="text-sm sm:text-lg font-semibold" onClick={() => setMenuOpen(false)}>
              Exhibition
            </Link>
          </li>
          <li>
            <Link href="/about" className="text-sm sm:text-lg font-semibold" onClick={() => setMenuOpen(false)}>
              About
            </Link>
          </li>
        </ul>
