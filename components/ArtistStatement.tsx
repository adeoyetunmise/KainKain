...
const ArtistStatement: React.FC = () => {
  return (
    <section className="bg-smoke-white pt-3 sm:pt-4 md:pt-6">
      <div className="flex flex-col lg:flex-row justify-between items-start gap-6 sm:gap-8 py-8 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 container mx-auto">
        ...
        <div className="flex-1 space-y-6 lg:space-x-14 sm:space-y-8 md:space-y-10">
          ...
          <button className="bg-custom-black text-smoke-white px-4 sm:px-6 py-2 lg:mt-10 mt-2 sm:mt-4 hover:bg-custom-black/80 transition-colors text-sm sm:text-base">
            Read More
          </button>
        </div>

        {/* Right Images - Fully responsive layout */}
        <div className="flex-1 relative w-full mt-8 lg:mt-0 max-w-full sm:max-w-[500px] lg:max-w-full mx-auto lg:mx-0">
